 ...
 ***************************************************************************/
/**
 * \file createCurveWidget.h
 * \brief A brief file description
 **/
#ifndef createCurveWidget_H
#define createCurveWidget_H
...
//!   Create Curve Widget
/*! 
	The Create Curve Widget provides functionality to control the 
	creation of curves,...
 */
    class createCurveWidget : public QWidget
    {
        Q_OBJECT

    public:
	createCurveWidget(QWidget *parent=0);
	~createCurveWidget();
