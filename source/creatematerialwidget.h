 ...
 ***************************************************************************/
//
#ifndef CREATEMATERIALWIDGET_H
#define CREATEMATERIALWIDGET_H

#include <QtGui>

class createMaterialWidget : public QWidget
{
    Q_OBJECT
public:
    createMaterialWidget(QWidget *parent = 0);
    ...
    //! Starts the Material creation
    void startMaterialCreation(QString,double,double,double);

};

#endif // CREATEMATERIALWIDGET_H
