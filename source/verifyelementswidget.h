 ...
 ***************************************************************************/
/**
 * \file verifyelementswidget.h
 * \brief A brief file description
 **/

#ifndef VERIFYELEMENTSWIDGET_H
#define VERIFYELEMENTSWIDGET_H

#include <QtGui>

class verifyElementsWidget : public QWidget
{
     Q_OBJECT
public:
    verifyElementsWidget(QWidget *parent = 0);
